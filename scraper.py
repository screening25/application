...
def fetch_jobs(
    ...
    include_keywords = list(include_keywords) if include_keywords else INCLUDE_KEYWORDS
    exclude_keywords = list(exclude_keywords) if exclude_keywords else EXCLUDE_KEYWORDS
    ...
    for keyword in search_keywords:
        for page in range(1, max_pages + 1):
            ...
            for item in soup.select("div.item_recruit"):
                ...
                if _contains_noise(combined, exclude_keywords):
                    continue
                if include_keywords and not _matches_include(combined, include_keywords):
                    continue
